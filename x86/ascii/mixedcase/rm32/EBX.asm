...
decode_loop:
	INC     ESI
	IMUL    EAX, [BYTE EBX + 2*ESI + jnz_marker + 1 - ((esi_value+1)*2)], BYTE 0x30
	XOR     AL,  [BYTE EBX + 2*ESI + jnz_marker + 2 - ((esi_value+1)*2)]
	XOR     [BYTE EBX + ESI + jnz_marker + 1 - (esi_value+1)], AL
