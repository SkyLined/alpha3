...
decode_loop:
	INC     ESI
	IMUL    EAX, [BYTE EBP + 2*ESI + jnz_marker + 1 - ((esi_value+1)*2)], BYTE 0x30
	XOR     AL,  [BYTE EBP + 2*ESI + jnz_marker + 2 - ((esi_value+1)*2)]
	XOR     [BYTE EBP + ESI + jnz_marker + 1 - (esi_value+1)], AL
