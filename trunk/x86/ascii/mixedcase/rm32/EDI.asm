...
decode_loop:
	INC     ESI
	IMUL    EAX, [BYTE EDI + 2*ESI + jnz_marker + 1 - ((esi_value+1)*2)], BYTE 0x30
	XOR     AL,  [BYTE EDI + 2*ESI + jnz_marker + 2 - ((esi_value+1)*2)]
	XOR     [BYTE EDI + ESI + jnz_marker + 1 - (esi_value+1)], AL
